...
export default function MeetKazSection() {
  return (
    <section 
      className="py-16 px-4 sm:px-6 md:px-16" 
    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <div className="relative aspect-square w-full max-w-sm sm:max-w-md mx-auto lg:mx-0">
              <Image
                src="/headshot.jpg"
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
            className="order-1 lg:order-2 lg:pl-8 flex flex-col justify-center min-h-full text-center lg:text-left"
          >
            {/* Section Title */}
            <motion.h2
            ...
            <motion.p
              ...
              viewport={{ once: true, amount: 0.3 }}
              className="text-base sm:text-lg text-gray-400 mb-6 sm:mb-8 font-medium break-words"
              style={{ fontFamily: 'Manrope, sans-serif' }}
            >
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.3 }}
              className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center lg:items-start"
            >
              {/* Learn More Button */}
              <a
                href="#"
                className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-white/10 backdrop-blur-xl border border-white/20 text-white font-medium rounded-lg hover:bg-white/15 hover:border-white/30 transition-all duration-300 shadow-xl text-sm sm:text-base"
              >
                Learn More
                <svg 
              ...
              <div className="flex gap-2 sm:gap-3">
                ...
                <a
                  ...
                  className="w-10 h-10 sm:w-12 sm:h-12 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full flex items-center justify-center hover:bg-white/15 hover:border-white/30 transition-all duration-300 group"
                  aria-label="Email Kaz Visk"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
